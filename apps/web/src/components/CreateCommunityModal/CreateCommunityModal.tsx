                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-8">
                      <div className="sm:col-span-6">
                        <label htmlFor="communityPhoto" className="block text-sm font-medium text-gray-700 text-left">
                          Photo
                        </label>
                      ...
                      <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div className="sm:col-span-6">
                          <label htmlFor="communityName" className="block text-sm font-medium text-gray-700 text-left">
                            Name
                          </label>
                          <div className="mt-1">
                            <input
                        ...
                        <div className="sm:col-span-6">
                          <label htmlFor="communitySlug" className="block text-sm font-medium text-gray-700 text-left">
                            Community URL
                          </label>
